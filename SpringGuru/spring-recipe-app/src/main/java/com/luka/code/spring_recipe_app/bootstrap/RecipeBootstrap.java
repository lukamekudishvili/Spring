package com.luka.code.spring_recipe_app.bootstrap;

import com.luka.code.spring_recipe_app.domain.Difficulty;
import com.luka.code.spring_recipe_app.domain.Ingredient;
import com.luka.code.spring_recipe_app.domain.Notes;
...
import com.luka.code.spring_recipe_app.repositories.Ingredient.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final Ingredient.UnitOfMeasureRepository unitOfMeasureRepository;

    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, Ingredient.UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<Ingredient.UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByDescription("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Ingredient.UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Ingredient.UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Ingredient.UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Ingredient.UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Ingredient.UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        ...
        //get optionals
        Ingredient.UnitOfMeasure eachUom = eachUomOptional.get();
        Ingredient.UnitOfMeasure tableSpoonUom = tableSpoonUomOptional.get();
        Ingredient.UnitOfMeasure teapoonUom = tableSpoonUomOptional.get();
        Ingredient.UnitOfMeasure dashUom = dashUomOptional.get();
        Ingredient.UnitOfMeasure pintUom = pintUomOptional.get();
        Ingredient.UnitOfMeasure cupsUom = cupsUomOptional.get();
